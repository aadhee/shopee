...
String query = "INSERT INTO tablets (name,brand,model,price,description) VALUES ('"+uid+"','"+name+"','"+aut+"','"+pub+"','"+des+"');";
...
if(i>0)  
{
out.println("THANKS FOR YOUR TABLET"+(String)session.getAttribute("name"));
