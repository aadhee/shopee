...
var wp = document.getElementById('txt').value;
	var queryString = "?age=" + age + "&wpm=" + wpm + "&wpmm=" + wpmm + "&wp=" + wp;
	ajaxRequest.open("GET", "sell2.jsp" + queryString, true);
	ajaxRequest.send(null); 
}
</script>
</head>
...
<caption>TABLETS-DETAILS</caption>
  ...
  <option value="	NOKIA">MICROSOFT</option>
  ...
  <option value="APPLE">APPLE</option>
      ...
      <tr>
            ...
            <td>
                ...
                <input type="text" name="reg" id="aut" />
            </td>
        ...
        <td>
            ...
            <input type="number" name="pub" id="pub"/>
        </td>
       ...
       <tr align="center">
        ...
        <tr align="center">
            ...
            <td>
                ...
                submit button-->
                <input type='button' onclick='ajaxFunction1()' value="SUBMIT"  />
            </td>

            <td>
                <!--Reset Button-->
               <a href="tablets.jsp"><input type="button" value="RELOAD"></a>
            </td>
        </tr>
</form>
