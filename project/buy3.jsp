...
{String select="Select * from tablets where brand='"+name+"' and model='"+aut+"'and price='"+pub+"';";
...
{String select="Select * from tablets where brand='"+name+"' and model='"+aut+"';";
...
String select="Select * from tablets where brand='"+name+"';";
ResultSet rel=ps.executeQuery(select);
if (rel.next())
